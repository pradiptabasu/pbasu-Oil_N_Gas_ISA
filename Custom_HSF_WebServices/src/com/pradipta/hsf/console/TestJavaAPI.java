...
//				}
                                connector.OpenServer("HSFServer");
			}
			else
			{
...
//				}
                                connector.OpenEntity("OnG_Consolidated_Monthly", Boolean.valueOf(true));
			}
			else
			{
...
//			}
		...
		finally
		{
			if (loggedIn)
			{
				...
				try
				{
				    connector.CloseEntity("OnG_Consolidated_Monthly",  false, true);
					if (connector.Logout()) {
