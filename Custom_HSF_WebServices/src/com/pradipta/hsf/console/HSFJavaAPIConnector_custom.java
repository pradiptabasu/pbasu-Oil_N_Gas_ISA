...
public class HSFJavaAPIConnector_custom {
    ...
    public HSFJavaAPIConnector_custom(String hostName, String portNumber) {
    ...
    public boolean Login(String userName, String password, String token) throws HSFException {
    ...
    public boolean Logout() throws HSFException {
    ...
    public Vector<String> EnumerateServers() throws HSFException {
        logger.entering(new Object[0]);
        if (!isSessionOpen()) {
    ...
    public boolean OpenServer(String server) throws HSFException {
        ...
        boolean retVal = false;
        String request =
            "<req_OpenServer><sID>" + this.sessionId + "</sID><server>" + server + "</server></req_OpenServer>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
                String status = Util.getNodeValue(response, "result");
    ...
    public boolean CloseServer() throws HSFException {
        logger.entering(new Object[0]);
        if (!isSessionOpen()) {
            throw new HSFException("Invalid session");
        }
        ...
        boolean retVal = false;
        String request =
            "<req_CloseServer><sID>" + this.sessionId + "</sID><server>" + this.server + "</server></req_CloseServer>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
                String status = Util.getNodeValue(response, "result");
    ...
    public Vector<String> EnumerateDatabases() throws HSFException {
        logger.entering(new Object[0]);
        if (!isSessionOpen()) {
            throw new HSFException("Invalid session");
        }
    ...
    public boolean OpenDatabase(String database) throws HSFException {
        ...
        boolean retVal = false;
        String request =
            "<req_OpenDatabase><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            database + "</database></req_OpenDatabase>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
                String status = Util.getNodeValue(response, "result");
    ...
    public boolean CloseDatabase() throws HSFException {
        logger.entering(new Object[0]);
        if (!isSessionOpen()) {
            throw new HSFException("Invalid session");
        }
        ...
        boolean retVal = false;
        String request =
            "<req_CloseDatabase><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database></req_CloseDatabase>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
                String status = Util.getNodeValue(response, "result");
    ...
    public Vector<String> EnumerateEntities(String parent, String action) throws HSFException {
        ...
        String request =
            "<req_EnumEntities><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database>" + "<entity>" + parent + "</entity><action>" + action +
            "</action></req_EnumEntities>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
    ...
    public boolean OpenEntity(String entity, Boolean checkOut) throws HSFException {
        ...
        boolean retVal = false;
        String request =
            "<req_OpenEntity><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database>" + "<entity>" + entity + "</entity><checkOut>" + checkOut.toString() +
            "</checkOut></req_OpenEntity>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
                String status = Util.getNodeValue(response, "result");
    ...
    public boolean CloseEntity(String entity, Boolean checkIn, Boolean releaseLock) throws HSFException {
        ...
        boolean retVal = false;
        String request =
            "<req_CloseEntity><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database>" + "<entity>" + entity + "</entity><checkIn>" + checkIn.toString() +
            "</checkIn><releaseLock>" + releaseLock.toString() + "</releaseLock></req_CloseEntity>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
                String status = Util.getNodeValue(response, "result");
    ...
    public Vector<Account> EnumerateAccounts(String entity) throws HSFException {
        ...
        String request =
            "<req_EnumAccounts><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database>" + "<entity>" + entity + "</entity></req_EnumAccounts>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
    ...
    public Vector<String> EnumerateScenarios(String entity) throws HSFException {
        logger.entering(new Object[] { entity });
        if (!isSessionOpen()) {
            throw new HSFException("Invalid session");
        }
        ...
        String request =
            "<req_EnumScenarios><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database>" + "<entity>" + entity + "</entity></req_EnumScenarios>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
    ...
    public Vector<String> EnumerateTimePeriods(String entity) throws HSFException {
        logger.entering(new Object[] { entity });
        if (!isSessionOpen()) {
            throw new HSFException("Invalid session");
        }
        ...
        String request =
            "<req_EnumTimePeriods><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database>" + "<entity>" + entity + "</entity></req_EnumTimePeriods>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
    ...
    public Vector<String> EnumerateCustomDimensions(String entity) throws HSFException {
        logger.entering(new Object[] { entity });
        if (!isSessionOpen()) {
            throw new HSFException("Invalid session");
        }
        ...
        String request =
            "<req_EnumCustomDimensions><sID>" + this.sessionId + "</sID><server>" + this.server +
            "</server><database>" + this.database + "</database>" + "<entity>" + entity +
            "</entity></req_EnumCustomDimensions>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
    ...
    public Vector<String> EnumerateCustomMembers(String dimension) throws HSFException {
        ...
        String request =
            "<req_EnumCustomMembers><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database>" + "<entity>" + this.entity + "</entity><dimension>" + dimension +
            "</dimension></req_EnumCustomMembers>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
    ...
    public String GetEntityLockInfo(String entity) throws HSFException {
        logger.entering(new Object[] { entity });
        if (!isSessionOpen()) {
            throw new HSFException("Invalid session");
        }
        ...
        String request =
            "<req_GetEntityLockInfo><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database>" + "<entity>" + entity + "</entity></req_GetEntityLockInfo>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
    ...
    public String GetEntityDataCells(String entity, String account, String time, String scenario,
                                     String measure) throws HSFException {
        ...
        String request =
            "<req_GetEntityDataCells><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database>" + "<entity>" + entity + "</entity><account>" + account + "</account><time>" +
            time + "</time>" + "<scenario>" + scenario + "</scenario><measure>" + measure +
            "</measure></req_GetEntityDataCells>";
    ...
    public String GetEntityDataCellsMultiple(String entity, String account, String time, String scenario,
                                             String measure) throws HSFException {
        logger.entering(new Object[] { entity, account, time, scenario, measure });
        if (!isSessionOpen()) {
            throw new HSFException("Invalid session");
        ...
        String request =
            "<req_GetEntityDataCells><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database>" + "<entity>" + entity + "</entity><account>" + account + "</account><time>" +
            time + "</time></req_GetEntityDataCells>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
    ...
    public boolean SetEntityDataCells(String entity, DataCellInfo[] dataCellArr) throws HSFException {
        logger.entering(new Object[] { entity });
        if (!isSessionOpen()) {
            throw new HSFException("Invalid session");
        }
    ...
    public Vector<String> EnumerateConsolidations() throws HSFException {
        logger.entering(new Object[0]);
        if (!isSessionOpen()) {
            throw new HSFException("Invalid session");
        }
        ...
        String request =
            "<req_EnumConsolidations><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database></req_EnumConsolidations>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
    ...
    public String RunConsolidation(String consName, String parent, String scenario) throws HSFException {
        ...
        String request =
            "<req_RunConsolidation><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database>" + "<consName>" + consName + "</consName><parent>" + parent +
            "</parent><scenario>" + scenario + "</scenario></req_RunConsolidation>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
    ...
    public String GetTransactionStatus(String transactionID) throws HSFException {
        ...
        String request =
            "<req_GetTransactionStatus><sID>" + this.sessionId + "</sID><server>" + this.server +
            "</server><database>" + this.database + "</database>" + "<transactionID>" + transactionID +
            "</transactionID></req_GetTransactionStatus>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
    ...
    public Vector<ECM> EnumerateECMs() throws HSFException {
        logger.entering(new Object[0]);
        if (!isSessionOpen()) {
            throw new HSFException("Invalid session");
        }
        ...
        String request =
            "<req_EnumerateECMs><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database></req_EnumerateECMs>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
    ...
    public Vector<ACM> EnumerateACMs() throws HSFException {
        logger.entering(new Object[0]);
        if (!isSessionOpen()) {
            throw new HSFException("Invalid session");
        }
        ...
        String request =
            "<req_EnumerateACMs><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database></req_EnumerateACMs>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
    ...
    public String RunECM(String ecmName) throws HSFException {
        ...
        String request =
            "<req_RunECM><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database>" + "<ecmName>" + ecmName + "</ecmName></req_RunECM>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
                return Util.getNodeValue(response, "transactionID");
    ...
    public String RunACM(String acmName) throws HSFException {
        ...
        String request =
            "<req_RunACM><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database>" + "<acmName>" + acmName + "</acmName></req_RunACM>";
        try {
            String response = SendRequest(request);
            if ((response != null) && (!response.equalsIgnoreCase(""))) {
                return Util.getNodeValue(response, "transactionID");
    ...
    private String getRequest(String entity, DataCellInfo[] dataCellArr) {
        String request =
            "<req_SetEntityDataCells><sID>" + this.sessionId + "</sID><server>" + this.server + "</server><database>" +
            this.database + "</database>" + "<entity>" + entity + "</entity><DataCells>";
